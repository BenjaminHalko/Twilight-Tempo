...
function Input() {
	...
	key_select = keyboard_check_pressed(vk_anykey) && !keyboard_check_pressed(vk_f4) && !keyboard_check_pressed(vk_f11) && !key_left_pressed && !key_right_pressed && !key_up_pressed && !key_down_pressed;
